...
public class MainActivity extends Activity {
    ...
    private void buildSetupScreen() {
        ...
        info.setText("Bu cihazın lokasiyası valideyn paneli ilə paylaşılır. Aktivləşdirmə üçün aşağıdakı düyməyə toxunun və Android-in tələb etdiyi icazələri verin.");
        info.setTextSize(15);
    ...
    TextView info = new TextView(this);
    info.setText("Cihaz təhlükəsizliyi hazırdır.
Təhlükəsizlik və valideyn nəzarəti ayarları aktivdir. Cihaz konfiqurasiyası tamamlanıb.");
    info.setTextSize(17);
...
private View space() {
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == REQ_LOCATION) {
            if (grantResults.length > 0 &&
                ...
                status.setText("Lokasiya icazəsi verilməyib.");
            }
    ...
    private void updateStatus() {
        ...
        boolean loc = checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
                || checkSelfPermission(Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED;
        status.setText(loc ? "Lokasiya icazəsi verilib." : "Lokasiya icazəsi gözlənilir.");
    }
